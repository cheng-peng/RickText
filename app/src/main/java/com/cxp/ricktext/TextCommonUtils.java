...
import com.cxp.ricktext.listener.ITextViewShow;
...
/**
 * 文 件 名: TextCommonUtils
 * 创 建 人: CXP
 * 创建日期: 2018-10-15 10:55
 * 描    述: 通用处理问题的Utisl
 * 修 改 人:
 * 修改时间：
 * 修改备注：
            ...
            if (index > 0) {
                ...
                if (hadAt && (matchEnd <= lenght || indexEnd == lenght)) {
                    ...
                    if (clickTopicSpan == null) {
                        clickTopicSpan = new ClickTopicSpan(listTopic.get(i), color, spanTopicCallBack);
                    }
